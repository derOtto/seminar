\chapter{Grundlagen und verwandte Arbeiten}\label{ch:grundlagen-und-verwandte-arbeiten}
...
%
\section{Der erste Abschnitt des Kapitels}\label{sec:der-erste-abschnitt-des-kapitels}
...
\subsection{Ein Unterabschnitt}\label{ssec:ein-unterabschnitt}
...
\subsection{Ein weiterer Unterabschnitt}\label{ssec:ein-weiterer-unterabschnitt}
...
%
\section{Ein zweiter Abschnitt}\label{sec:ein-zweiter-abschnitt}
...
\subsection{Ein Anderer Unterabschnitt}\label{ssec:ein-anderer-unterabschnitt}
...
\subsubsection{Ein Unter-Unterabschnitt}\label{sssec:ein-unter-unterabschnitt}
