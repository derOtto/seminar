...
This works now also with \textquote{plain} \LaTeX.
...
\begin{itemize}
    ...
    body\dots}
    \item\texttt{Chapters/} is where all the \textquote{real} content goes in
    separate files such as \texttt{Chapter01.tex} etc.
    % \item\texttt{Examples/} is where you store all listings and other
    % examples you want to use for your text.
    \item\texttt{FrontBackMatter/} is where all the stuff goes that
    surrounds the \textquote{real} content, such as the acknowledgments,
    dedication, etc.
    ...
    transition from the \textquote{basic} style to \mLyX.
\end{itemize}
...
\begin{itemize}
    ...
    \item Table of Contents:
        \begin{itemize}
            ...
            However, it does not look as \textquote{perfect} if you use
